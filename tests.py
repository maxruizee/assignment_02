...
class TestAssignmentTwo_Strings(unittest.TestCase):
    ...
    def test_escaping_quotes(self):
        ...
        """
        a = "He said, \"Don't forget to relax a little\"" # unescaped single quote
        b = 'He said, "Don\'t" forget to relax a little' # unescaped double quote
    ...
    def test_format_rounding(self):
        ...
        rounded_pi = str(round(pi))
        self.assertEqual(rounded_pi, s.format(3))
    ...
    def test_write_your_own(self):
        ...
        nnn = 'N1'
        nn = nn.strip()
        nnn = nnn.replace('1', 'one')

        self.assertTrue(nn, nnn)  # You can either fix this line or remove it once the test is in.
